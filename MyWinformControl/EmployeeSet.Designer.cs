...
namespace MyWinformControl.EmployeeSetTableAdapters {
...
SELECT EmployeeID, LastName, FirstName, Title, TitleOfCourtesy, BirthDate, HireDate, Address, City, Region, PostalCode, Country, HomePhone, Extension, Photo, Notes, ReportsTo, PhotoPath FROM Employees WHERE (EmployeeID = SCOPE_IDENTITY())";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::MyWinformControl.Properties.Settings.Default.ConnectionString;
        }
        ...
        public virtual int Fill(EmployeeSet.EmployeesDataTable dataTable) {
        ...
        public virtual EmployeeSet.EmployeesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            EmployeeSet.EmployeesDataTable dataTable = new EmployeeSet.EmployeesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(EmployeeSet.EmployeesDataTable dataTable) {
